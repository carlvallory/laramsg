                                    ...
                                    @foreach($msgs as $key => $msg)
                                        <div class="chat_message_wrapper">
                                            <div class="chat_user_avatar">
                                                ...
                                                <img alt="{{base64_decode($msg->msg_name)}}" title="{{base64_decode($msg->msg_name)}}" src="{{base64_decode($msg->msg_image) ? base64_decode($msg->msg_image) : asset('images/default.svg')}}" class="md-user-image">
                                                </a>
                                            </div>
