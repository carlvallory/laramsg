                                ...
                                <div class="sender">
                                    ...
                                    @if($msg->trashed())
                                        <form method="DELETE" action="{{ route('admin.msgs.restore', $msg->id) }}" class="msg-deleted" data-id="{{$msg->id}}">
                                            @csrf
                                            <span class="bs-checkbox bs-checkbox-success"><input type="checkbox" onChange="this.form.submit()" name="delete" value="{{$msg->id}}"></span>
                                        </form>
                                    @else
                                        <form method="DELETE" action="{{ route('admin.msgs.delete', $msg->id) }}" class="msg-restored d-none" data-id="{{$msg->id}}">
                                            @csrf
                                            <span class="bs-checkbox bs-checkbox-success">
                                    ...
                                    @if($msg->isActive())
                                        <form method="DELETE" action="{{ route('admin.msgs.activate', $msg->id) }}" class="msg-deactivated" data-id="{{$msg->id}}">
                                            @csrf
                                            <span class="bs-checkbox bs-checkbox-danger"><input type="checkbox" onChange="this.form.submit()" name="delete" value="{{$msg->id}}"></span>
                                        </form>
                                    @else
