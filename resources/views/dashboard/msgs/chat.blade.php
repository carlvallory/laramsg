                    ...
                    $.ajax(
                    {
                        ...
                        success: function (){
                            if(newForm.hasClass('msg-deactivated') || newForm.hasClass('msg-activated')) {
                                newForm.parents('.message-body > .msg-activated:not([data-id="' +newId+ '"])').child('input[type="checkbox"]').prob('checked', false);
                                newForm.parents('.message-body > .msg-deactivated:not([data-id="' +newId+ '"])').child('input[type="checkbox"]').prob('checked', false);
